...
git clone https://github.com/NENO16/GENERAL.git
➖🔹➖🔹➖🔹➖🔹➖🔹
ورهأ خلي    
...
sudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev libevent-dev libjansson* libpython-dev make unzip git redis-server g++ -y --force-yes && git clone https://github.com/NENO16/GENERAL.git && cd TH3BOSS && chmod +x GENERAL.sh && ./GENERAL.sh install && ./GENERAL.sh
```
